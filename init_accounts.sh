...
# =========================
# Create ATAs (payer is fee-payer for everyone)
# =========================
echo "Creating ATAs…"
...
echo "Mint to payer:   $MINT_AMOUNT_UI_PAYER (raw=$RAW_PAYER)"
mint_to "$MINT" "$RAW_PAYER" "$PAYER_ATA" "$PAYER_KEYPAIR"

echo "Mint to player2: $MINT_AMOUNT_UI_P2 (raw=$RAW_P2)"
